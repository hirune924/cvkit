...
class CustomDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        if stage == 'fit':
            ...
            if self.conf.o2u_log is not None:
                o2u = pd.read_csv(self.conf.o2u_log)
                o2u = o2u.sort_values('loss_avg', ascending=False)
                o2u = o2u[int(len(o2u)*self.conf.remove_ratio):]
                train_df = train_df[train_df['image_path'].isin(o2u['image_path'])]
